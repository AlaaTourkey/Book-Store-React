      ...
      <nav className="bg-zinc-800 border-gray-200 drop-shadow-2xl  px-4 lg:px-6 py-4 shadow-xl top-0 text-white">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <a href="#" className=" bg-blue-400 hover:bg-blue-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 lg:px-5 lg:py-2 lg:mr-2 focus:outline-none">Sign Up</a>
