...
function Card({ isOpen, onClose, book }) {
  ...
  return (
    <div className="scale-up-center fixed inset-0 flex items-center justify-center z-50 p-3 overflow-y-auto">
      <div className="bg-gray-800 bg-opacity-95 p-5 rounded-lg w-full sm:w-3/4 lg:w-11/12 shadow-lg max-h-full overflow-y-auto">
        <div className="flex justify-end">
          <button className="text-red-500 hover:text-red-700 text-xl" onClick={onClose}> Close </button>
        </div>
