      ...
      <div className="grid grid-cols-5">
        <div className="col-span-1 px-6">
          ...
          <ul className="cursor-pointer">
            {['fiction', 'fantasy', 'mystery', 'philosophy', 'thriller', 'biography', 'autobiography', 'picture books', 'children\'s literature', 'children', 'health', 'technology', 'business', 'science', 'politics'].map((category) => (
              <li key={category} className="my-4 group" onClick={() => handleCategorySelection(category)}>
                <i className="fa-solid fa-square text-white group-hover:text-amber-800 group-hover:rotate-45 text-xs mx-3 transition-all  duration-300 ease-out "></i>
